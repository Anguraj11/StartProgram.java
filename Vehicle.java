...
public class Vehicle {
    ...
    protected RentRecord records[]= new RentRecord[10];
    ...
    public boolean rent(String customerId, DateTime rentDate, int numOfRentDay)
    {
          ...
          else if( typeOfVehicle.equals("van") )
          {
              ...
              this.records[this.getLastElementIndex()+1]=new RentRecord(rentId,rentDate,new DateTime(rentDate,numOfRentDay));
