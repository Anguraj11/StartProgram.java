...
class  RentSystem{
	//car and van are two collections used to store car of type Car and vans of type Van respectively
    ...
    public void run() {
		...
		while (true) {
			...
			System.out.println("\n**** RENT SYSTEM MENU IS HERE WHAT IS YOUR CHOICES ****\n");
			...
			switch (choice) {
				case 1:
					this.add(sc); //Method used to add either car or van
					break;
				case 2:
					this.rent(sc); //Method used to rent either car or van
					break;
				case 3:
	...
	/**
	 * Used to add either car or van to the list
    ...
    private void add(Scanner scan)
    {
		...
		{
			System.out.print("Please enter Your choice van or car: ");
		...
		if(vehicleType.equals("car")) {
			...
			while ((seats != 4 && seats != 7)) {
				System.out.println("Please enter your seat either 4 or 7");
				seats = Integer.parseInt(scan.nextLine());
			}
			if(i<50){
	...
	private void rent(Scanner sc)
	{
		...
		{
			System.out.println("There are no car currently at the moment.");
			return;
		}
		if(id.contains("V_") && this.vans[0]==null)
		{
			System.out.println("There are no van currently at the moment.");
			return;
		}
